                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="single-main">
                                <h2 className="mb-3">
                                    <a href="blog-single.html" style={{ color: '#1C77D1', fontSize: '33px' }}>
                                        {newsDetail.name}
                                    </a>
                                </h2>
                                        ...
                                        <span class="author img-fluid">
                                            <a href="#">
                                                <img
                                                    ...
                                                    src="https://tse4.mm.bing.net/th?id=OIP.qbWrUTnCKozFDIt7s0QUAgHaHa&pid=Api&P=0&h=180"
                                                    alt="#"
                                                />{' '}
                                                Nguyễn Phạm Bảo Khang
                                            </a>
                                        </span>
                                        <span class="date ml-5">
                                            <i class="fa fa-clock-o"></i>
                                            {new Date(newsDetail.created_at).toLocaleDateString()}
                                        </span>
                                        <span class="views ml-5">
                                            <i class="fa fa-eye"></i>
                                            {newsDetail.view.toLocaleString()} Lượt xem
                                        </span>
                                    </div>
                                </div>
