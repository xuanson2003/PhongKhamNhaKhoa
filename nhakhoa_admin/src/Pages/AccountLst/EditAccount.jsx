...
function EditAccount(props) {
    ...
    async function handleEditAccount() {
        try {
            ...
            if (responseUser.data.success) {
                openNotification('top', 'Thành công', 'Cập nhật người dùng thành công', 'success');
            } else {
                openNotification('top', 'Thất bại', 'Cập nhật người dùng thất bại', 'error');
            }
        } catch (err) {
            console.log(err);
        } finally {
    ...
    return (
        <div>
            ...
            <Card title={`Chỉnh sửa người dùng`} bordered={true} className="mt-3">
                <div className="row">
